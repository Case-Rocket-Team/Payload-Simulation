...
class UnsteadyState:
    ...
    def calcLiftForce(self, parafoil, unsteady_parafoil_state):
        return 0.5 * density * (unsteady_parafoil_state['Velocity'] ** 2) * parafoil['Canopy Area'] * parafoil['Coeffecient of Lift']
    
    # Calculate Drag Force
    def calcDragForce(self, parafoil, unsteady_parafoil_state):
        return 0.5 * density * (unsteady_parafoil_state['Velocity'] ** 2) * parafoil['Canopy Area'] * parafoil['Coffecient of Drag']
