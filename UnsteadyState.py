...
class UnsteadyState:
    ...
    def checkBankAngle(self, unsteady_parafoil_state):
        unsteady_parafoil_state['Bank Angle'] = util.clamp(unsteady_parafoil_state['Bank Angle'], 20, -20)

    def runControlLoop(self, parafoil, parafoil_state, unsteady_parafoil_state, target, kp, kd, ki, dt):
        print(kp)
        ctrl = ControlLogic()
        ...
        while unsteady_parafoil_state['Altitude'] > 0:
            ...
            unsteady_parafoil_state['Bank Angle'] = pid.calculate(delta, dt)
